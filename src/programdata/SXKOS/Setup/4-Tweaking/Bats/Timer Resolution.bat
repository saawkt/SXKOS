...
start "" "C:\ProgramData\SXKOS\bin\3\TimerResolution.exe" --resolution 5000 --no-console
timeout /t 2 /nobreak >NUL 2>&1
exit
...
start "" "C:\ProgramData\SXKOS\bin\3\TimerResolution.exe" --resolution %value% --no-console
timeout /t 2 /nobreak >NUL 2>&1
exit
